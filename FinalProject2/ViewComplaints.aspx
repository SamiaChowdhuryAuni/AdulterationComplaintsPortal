<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewComplaints.aspx.cs" Inherits="FinalProject2.ViewComplaints" %>
...
Portal
    ...
    <div class="table-responsive">
        <table class="table" id="cmtable">
            <tr>
                <td>User ID</td>
                <td><asp:Label runat="server" Text="Label" ID="uid"></asp:Label></td>
