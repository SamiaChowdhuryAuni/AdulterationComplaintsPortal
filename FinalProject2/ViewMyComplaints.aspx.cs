...
{
    public partial class ViewMyComplaints : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string query = "Select Area, Category,Complaints,ImgData from UserComplaints where ComplaintID='" + cid + "'";
